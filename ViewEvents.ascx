...
<dnn:DnnJsInclude runat="server" FilePath="~/DesktopModules/flowmarks_Events/jquery-ui-sliderAccess.js" />
...
<script type="text/javascript" charset="utf-8">
    ...
    function initialize() {
        ...
        $(".dateEventDate").datetimepicker({
            ...
            showOn: 'button',
            buttonImage: "/DesktopModules/flowmarks_Events/images/date-picker.png",
    ...
    <table class="topnavi" cellpadding="0" cellspacing="0" width="100%" style="background-color: White">
        ...
        <tr>
            <td class="left" nowrap>
                ...
                |
                <asp:HyperLink ID="lnkSettings" runat="server" CssClass="large lnkSettings" Text="Categories" ToolTip="Edit categories"></asp:HyperLink>
                <asp:Literal ID="litReportSeparator" runat="server" Text=" | "></asp:Literal>
                <asp:HyperLink ID="lnkReport" runat="server" CssClass="large lnkReport" Text="Reports" ToolTip="View reports"></asp:HyperLink>
            </td>
            <td class="center">
            ...
            <td class="right" nowrap>
                <asp:LinkButton ID="cmdAdd" runat="server" class="large" Text="New Event" OnClick="cmdAdd_Click"
                    ToolTip="New Event" CssClass="cmdAdd"></asp:LinkButton>

                <asp:DropDownList ID="ddlFilterCategory" runat="server" Width="150px" DataSourceID="dsFilterCategories"
                    DataTextField="Name" DataValueField="CategoryId" AutoPostBack="true" OnSelectedIndexChanged="ddlFilterCategory_SelectedIndexChanged" CssClass="ddlFilterCategory" />
    ...
    <div class="event old">
        <asp:ListView ID="lstContent" datakeyfield="EventId" runat="server" Style="width: 100%;"
                ...
                <tr>
                    <td>
                        <asp:LinkButton runat="server" ID="cmdEditRow" CommandName="Edit" CssClass="editArea" ToolTip='<% # ToolTip(Container.DataItem)%>'>
                            ...
                            <span class="small"><span id="cmdEdit" href="#edit" title="Edit event" class="linkButton">edit</span> </span>
                        </asp:LinkButton>
                    </td>
                </tr>
            </ItemTemplate>
                    ...
                    <td style="padding-top: 10px;">
                        <table border="0" cellspacing="0" cellpadding="0" runat="server" id="tblInsertEvent"
                            ...
                            <tr runat="server" id="trCategory">
                                <td class="tdField">
                                    <asp:Label ID="lblCategory" runat="server" AssociatedControlID="ddlCategory" Text='Category' CssClass="label">
                                    </asp:Label>
                                    <div class="field">
                            ...
                            <tr runat="server" id="trEventDate" class="trEventDate">
                                <td class="tdField">
                                    <asp:Label ID="lblEventDate" runat="server" AssociatedControlID="dateEventDate" CssClass="label">
                                    </asp:Label>
                                    <div class="field">
                            ...
                            <tr runat="server" id="trEventDate2" class="trEventDate2">
                                <td class="tdField">
                                    <asp:Label ID="lblEventDate2" runat="server" AssociatedControlID="dateEventDate2" CssClass="label">
                                    </asp:Label>
                                    <div class="field">
                            ...
                            <tr id="trName" runat="server">
                                <td class="tdField">
                                    <asp:Label ID="lblLabel" runat="server" AssociatedControlID="txtLabel" CssClass="label">
                                    </asp:Label>
                                    <div class="field">
                                        <asp:TextBox ID="txtLabel" runat="server" CssClass="fmTextBox" MaxLength="200" />
                            ...
                            <tr runat="server" id="trLabel2" class="trLabel2">
                                <td class="tdField">
                                    <asp:Label ID="lblLabel2" runat="server" AssociatedControlID="txtLabel2" CssClass="label">
                                    </asp:Label>
                                    <div class="field">
                            ...
                            <tr runat="server" id="trMeasurement">
                                <td class="tdField">
                                    <asp:Label ID="lblMeasurement" runat="server" AssociatedControlID="txtMeasurement" CssClass="label">
                                    </asp:Label>
                                    <div class="field">
                            ...
                            <tr runat="server" id="trMeasurement2" class="trMeasurement2">
                                <td class="tdField">
                                    <asp:Label ID="lblMeasurement2" runat="server" AssociatedControlID="txtMeasurement2"
                                        controlname="txtMeasurement2" CssClass="label">
                                    </asp:Label>
                                    <div class="field">
                            ...
                            <tr>
                                <td class="tdField top">
                                    <asp:Label ID="lblComments" runat="server" AssociatedControlID="txtComments" CssClass="label">
                                    </asp:Label>
                                    <div class="field">
                            ...
                            <tr id="trEventId" runat="server" class="trEventId">
                                <td class="tdField">
                                    <asp:Label ID="lblEventId" runat="server" AssociatedControlID="lblEventIdValue" CssClass="label">
                                    </asp:Label>
                                    <div class="field">
                            ...
                            <tr id="trExternalId" class="trExternalId">
                                <td class="tdField">
                                    <asp:Label ID="lblExternalId" runat="server" AssociatedControlID="txtExternalId" CssClass="label">
                                    </asp:Label>
                                    <div class="field">
            ...
            <EditItemTemplate>
                ...
                <tr class="edit">
                    <td>
                        <a id="current-edit" href="#current-edit"></a>
                        <table border="0" cellpadding="0" cellspacing="0" runat="server" id="tblEditEvent"
                            visible="true" class="tblEvent">
                            <tr runat="server" id="trCategory">
                                <td class="tdField">
                                    <asp:Label ID="lblCategory" runat="server" AssociatedControlID="ddlCategory" Text='Category' CssClass="label lblCategory">
                                    </asp:Label>
                                    <div class="field">
                                        <div class="fmCategories">
                                            <div class="fmColumn">
                            ...
                            <tr runat="server" id="trEventDate" class="trEventDate">
                                <td class="tdField">
                                    <asp:Label ID="lblEventDate" runat="server" AssociatedControlID="dateEventDate" Text='<% # GetLabel(Eval("Label_EventDate"), "lblEventDate")%>' CssClass="label">
                                    </asp:Label>
                                    <div class="field">
                            ...
                            <tr runat="server" id="trEventDate2" class="trEventDate2">
                                <td class="tdField">
                                    <asp:Label ID="lblEventDate2" runat="server" AssociatedControlID="dateEventDate2"
                                        suffix=":" Text='<% # GetLabel(Eval("Label_EventDate2"), "lblEventDate2")%>' CssClass="label">
                                    </asp:Label>
                                    <div class="field">
                                        <asp:TextBox ID="dateEventDate2" CssClass="dateEventDate2 fmTextBox" runat="server"
                            ...
                            <tr id="trName" runat="server">
                                <td class="tdField">
                                    <asp:Label ID="lblLabel" runat="server" AssociatedControlID="txtLabel" Text='<% # GetLabel(Eval("Label_Label"), "lblLabel")%>' CssClass="label">
                                    </asp:Label>
                                    <div class="field">
                                        <asp:TextBox ID="txtLabel" runat="server" CssClass="fmTextBox" MaxLength="200"
                                            Text='<% #Bind("Label")%>' />
                            ...
                            <tr runat="server" id="trLabel2" class="trLabel2">
                                <td class="tdField">
                                    <asp:Label ID="lblLabel2" runat="server" AssociatedControlID="txtLabel2"
                                        Text='<% # GetLabel(Eval("Label_Label2"), "lblLabel2")%>' CssClass="label">
                                    </asp:Label>

                                    <div class="field">

                                        <asp:TextBox ID="txtLabel2" CssClass="txtLabel2 fmTextBox" runat="server"
                                            MaxLength="200" Text='<% #Bind("Label2")%>'></asp:TextBox>
                                        <div id="cmdHideLabel2" class="ui-state-default ui-state-active ui-corner-all fmImageButton">
                                            <div class="ui-icon ui-icon-circle-minus">
                                                <a href="#hide" title="Hide">-</a>
                                            </div>
                            ...
                            <tr runat="server" id="trMeasurement">
                                <td class="tdField">
                                    <asp:Label ID="lblMeasurement" runat="server" AssociatedControlID="txtMeasurement"
                                        Text='<% # GetLabel(Eval("Label_Measurement"), "lblMeasurement")%>' CssClass="label">
                                    </asp:Label>
                                    <div class="field">
                                        <asp:TextBox ID="txtMeasurement" runat="server" CssClass="fmTextBox txtMeasurement" MaxLength="255"
                            ...
                            <tr runat="server" id="trMeasurement2" class="trMeasurement2">
                                <td class="tdField">
                                    <asp:Label ID="lblMeasurement2" runat="server" AssociatedControlID="txtMeasurement2"
                                        controlname="txtMeasurement2" Text='<% # GetLabel(Eval("Label_Measurement2"), "lblMeasurement2")%>' CssClass="label"
                                        suffix=":">
                                    </asp:Label>
                                    <div class="field">
                                        <asp:TextBox ID="txtMeasurement2" CssClass="txtMeasurement2 fmTextBox"
                            ...
                            <tr>
                                <td class="tdField top">
                                    <asp:Label ID="lblComments" runat="server" AssociatedControlID="txtComments" Text='<% # GetLabel(Eval("Label_Comments"), "lblComments")%>' CssClass="label">
                                    </asp:Label>
                                    <div class="field">
                                        <asp:TextBox ID="txtComments" runat="server" CssClass="fmTextBox" Height="100px"
                                            TextMode="multiline" Text='<% #Bind("Comments")%>'></asp:TextBox>
                            ...
                            <tr id="trEventId" runat="server" class="trEventId">
                                <td class="tdField">
                                    <asp:Label ID="lblEventId" runat="server" AssociatedControlID="lblEventIdValue" Text='ID' CssClass="label lblEventId">
                                    </asp:Label>
                            ...
                            <tr id="trExternalId" class="trExternalId">
                                <td class="tdField">
                                    <asp:Label ID="lblExternalId" runat="server" AssociatedControlID="txtExternalId"
                                        Text='<% # GetLabel(Eval("Label_ExternalId"), "lblExternalId")%>' CssClass="label lblExternalId">
                                    </asp:Label>
                                ...
                                <td>
                                    <div class="buttonwrapper">
                                        ...
                                        <asp:LinkButton ID="RemoveButton" runat="server" CommandArgument='<%# Bind("EventID")%>'
                                            CommandName="Delete" Text="Delete" class="deleteButton"></asp:LinkButton>
                                    </div>
                                </td>
                            </tr>
                        </table>
